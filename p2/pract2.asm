...
MOV MATRIZASC[0], 40 ; MÁXIMO NÚMERO DE CARACTERES
INT 21H
...
MOV DH, 0
JMP FINAL
NEGATIVO: MOV DH, -1 ; EXTENDEMOS EL SIGNO
FINAL: IMUL DX
RET
DIAG ENDP
...
CONT2:
CMP MATRIZASC[BX], 0DH ; MIRAMOS SI HA ACABADO LA CADENA INTRODUCIDA POR EL USUARIO
JE COMPR
MOV DL, MATRIZASC[BX]
SUB DL, 30H ; CONVERTIMOS UNA CIFRA EN ASCII EN EL NÚMERO QUE REPRESENTA
